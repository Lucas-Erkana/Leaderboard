...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_apis_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/apis.js */ \"./src/modules/apis.js\");\n\n\n\nlet gameIdentity = '';\nfetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games', {\n\n  method: 'POST',\n  headers: {\n    'Content-type': 'application/json; charset=UTF-8',\n  },\n  body: JSON.stringify({\n    name: 'Premier League Pes',\n  }),\n}).then((res) => res.json())\n  .then((gameID) => {\n    const response = gameID.result;\n    gameIdentity = response.substring(14, response.lastIndexOf(' '));\n  });\n\nconst refresh = document.querySelector('.ref-btn');\n\nrefresh.addEventListener('click', () => {\n  (0,_modules_apis_js__WEBPACK_IMPORTED_MODULE_1__.renderContainer)(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameIdentity}/scores`);\n});\n\nconst submitscore = document.getElementById('submit');\nconst yourName = document.getElementById('your-name');\nconst score = document.getElementById('score');\nsubmitscore.addEventListener('click', (e) => {\n  e.preventDefault();\n  if (yourName.value !== '' && score.value !== '') {\n    submitscore.classList.add('onfocuss');\n    (0,_modules_apis_js__WEBPACK_IMPORTED_MODULE_1__.toAddScore)(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameIdentity}/scores`, yourName.value, score.value);\n    document.forms[0].reset();\n  }\n});\n\n//# sourceURL=webpack://webpack_setup/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"renderContainer\": () => (/* binding */ renderContainer),\n/* harmony export */   \"toAddScore\": () => (/* binding */ toAddScore)\n/* harmony export */ });\n/* harmony import */ var _variables_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables.js */ \"./src/modules/variables.js\");\n\n\nconst renderContainer = async (gameLInk) => {\n  const res = await fetch(gameLInk);\n  await res.json()\n    .then((resData) => {\n      _variables_js__WEBPACK_IMPORTED_MODULE_0__.container.replaceChildren();\n      let counts = 1;\n      resData.result.forEach((scores, index) => {\n        _variables_js__WEBPACK_IMPORTED_MODULE_0__.container.innerHTML += `\n          <li>\n            <p>${scores.user}:</p>\n            <p>${scores.score}</p>\n          </li> `;\n        _variables_js__WEBPACK_IMPORTED_MODULE_0__.container.classList.add('conta');\n        if (counts % 2 === 0) {\n          _variables_js__WEBPACK_IMPORTED_MODULE_0__.container.children[index].classList.add('colored');\n        } else {\n          _variables_js__WEBPACK_IMPORTED_MODULE_0__.container.children[index].classList.add('not-colored');\n        }\n\n        counts += 1;\n      });\n    });\n};\n\nconst toAddScore = async (gameLInk, user, score) => {\n  await fetch(gameLInk, {\n    method: 'POST',\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8',\n    },\n    body: JSON.stringify({\n      user,\n      score,\n    }),\n  });\n};\n\n\n\n//# sourceURL=webpack://webpack_setup/./src/modules/apis.js?");
